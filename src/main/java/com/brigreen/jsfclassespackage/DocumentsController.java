...
import com.brigreen.sessionbeanpackage.DocumentsFacade;
...
public class DocumentsController implements Serializable {
    ...
    @EJB
    private com.brigreen.sessionbeanpackage.DocumentsFacade ejbFacade;
    ...
    public Documents getDocuments(java.lang.Integer id) {
    ...
    public static class DocumentsControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getDocuments(getKey(value));
        }
